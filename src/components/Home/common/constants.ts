...
export const MISSION_CONTENT = {
  title: "Who We Are",
  description: "ePublic Safety Foundation is a family-founded nonprofit dedicated to protecting consumers from financial deception — especially in timeshares in Florida, estate-related scams, and deceptive timeshare exit company practices.",
  ...
  goalStatement: "From pushing for stronger protections to helping you report a scam — everything we do is rooted in one goal:",
...
export const PETITION_CONTENT = {
  title: "Sign the Petition",
  description: "Help us demand new laws that protect consumers from deceptive practices — especially in timeshare sales, inheritance scams, and other financial traps targeting the vulnerable. We're calling on lawmakers to step in and finally hold bad actors accountable.",
  callouts: [
    "📢 Your voice matters — and your signature helps make it louder.",
    "📢 Your voice is power. One signature can help protect thousands."
  ],
  cta: "👉 Sign the Petition Now to be part of the change."
};

export const RIGHTS_CONTENT = {
  title: "Know Your Rights",
  description: "Most people don't know what protections they already have — let alone how to use them. That's by design.",
  ...
  cta: "Take back your power — Read the Consumer Rights Guide"
};
...
export const WHY_THIS_MATTERS = {
  ...
  callToAction: "It's time to say enough is enough — and push for action."
};

export const FINAL_CTA = {
  title: "You Can Make a Difference Today",
  actions: [
    "Stand up for victims and vulnerable families — Sign the Petition",
    "Empower yourself — Know Your Rights",
    "Report a scam — help us expose patterns and push for real protection",
    "Share this site with someone who's been scammed — let them know they're not alone"
  ],
