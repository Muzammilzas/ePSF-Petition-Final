...
if (!supabaseUrl || !supabaseAnonKey) {
  throw new Error('Missing Supabase environment variables. Please check your .env file and ensure VITE_SUPABASE_DATABASE_URL and VITE_SUPABASE_ANON_KEY are set.');
}
